...
//        String str = "wyj";
//        List<User> userList = userJpaRepository.findByNameIs(str);
//        System.out.println(userList);
//    }
//
//    @Test
...
//        String str = "wyj";
//        List<User> userList = userJpaRepository.findByNameEquals(str);
//        System.out.println(userList);
//    }
//
//    @Test
...
//        int littleAge = 17;
//        int bigAge = 18;
//        List<User> userList = userJpaRepository.findByAgeBetween(littleAge, bigAge);
//        System.out.println(userList);
//    }
//
//    @Test
...
//        int age = 19;
//        List<User> userList = userJpaRepository.findByAgeLessThan(age);
//        System.out.println(userList);
//    }
//
//    @Test
...
//        int age = 18;
//        List<User> userList = userJpaRepository.findByAgeLessThanEqual(age);
//        System.out.println(userList);
//    }
//
//    @Test
...
//        int age = 17;
//        List<User> userList = userJpaRepository.findByAgeGreaterThan(age);
//        System.out.println(userList);
//    }
//
//    @Test
...
//        int age = 18;
//        List<User> userList = userJpaRepository.findByAgeGreaterThanEqual(age);
//        System.out.println(userList);
//    }
//
//    @Test
//    public void findByOrderByAgeDesc() {
//        List<User> userList = userJpaRepository.findByOrderByAgeDesc();
//        System.out.println(userList);
//    }
//
//    @Test
...
//        String name = "Wyj";
//        List<User> userList = userJpaRepository.findByNameIgnoreCase(name);
//        System.out.println(userList);
//    }
//
//}
