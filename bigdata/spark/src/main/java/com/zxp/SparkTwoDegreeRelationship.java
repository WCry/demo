...
public class SparkTwoDegreeRelationship {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //直接关系结果
            JavaPairRDD<String, String> r4 = r3.filter((Function<Tuple2<String, String>, Boolean>) v1 -> {
                //如果包含直接关系 表示是否接受
            ...
            //链接二度关系 进行输出
            r5.foreach((VoidFunction<Tuple2<String, String>>) stringStringTuple2 -> System.out.println(stringStringTuple2));
