package com.zxp.order.service.seckill.mapper;



import com.zxp.order.service.seckill.bean.SeckillGoods;
...
public interface GoodsMapper {
    ...
    @Select("select g.*, sg.stock_count, sg.start_date, sg.end_date, sg.seckill_price, " +
            "sg.version from sk_goods_seckill sg left join sk_goods g on sg.goods_id = g.id")
